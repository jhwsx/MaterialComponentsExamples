...
import com.example.materialcomponentsexamples.databinding.ToolbarDemo11ActivityBinding
 ...
 * @date 8/5/20
 */
class ToolbarDemo11Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = ToolbarDemo11ActivityBinding.inflate(layoutInflater)
