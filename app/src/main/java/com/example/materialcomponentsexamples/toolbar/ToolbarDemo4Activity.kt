...
import com.example.materialcomponentsexamples.databinding.ToolbarDemo3ActivityBinding
import com.example.materialcomponentsexamples.databinding.ToolbarDemo4ActivityBinding
 ...
 * @date 8/5/20
 */
class ToolbarDemo4Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = ToolbarDemo4ActivityBinding.inflate(layoutInflater)
