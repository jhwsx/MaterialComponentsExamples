...
import com.example.materialcomponentsexamples.databinding.ToolbarDemo8ActivityBinding
 ...
 * @date 8/5/20
 */
class ToolbarDemo8Activity : AppCompatActivity() {
    val function: (MenuItem) -> Boolean = {
        when (it.itemId) {
            R.id.menu_toolbar_edit -> {
                Toast.makeText(this@ToolbarDemo8Activity, R.string.toolbar_edit, Toast.LENGTH_SHORT)
                    .show()
                true
            }
            R.id.menu_toolbar_send -> {
                Toast.makeText(this@ToolbarDemo8Activity, R.string.toolbar_send, Toast.LENGTH_SHORT)
                    .show()
                true
            }
            R.id.menu_toolbar_settings -> {
                Toast.makeText(
                    this@ToolbarDemo8Activity,
            ...
            R.id.menu_toolbar_share -> {
                Toast.makeText(this@ToolbarDemo8Activity, R.string.toolbar_share, Toast.LENGTH_SHORT)
                    .show()
                true
            }
            else -> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ToolbarDemo8ActivityBinding.inflate(layoutInflater)
